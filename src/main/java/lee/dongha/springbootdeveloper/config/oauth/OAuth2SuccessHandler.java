package lee.dongha.springbootdeveloper.config.oauth;

import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import lee.dongha.springbootdeveloper.config.jwt.TokenProvider;
import lee.dongha.springbootdeveloper.domain.RefreshToken;
...
import lee.dongha.springbootdeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private void clearAuthenticationAttributes(HttpServletRequest request, HttpServletResponse response){
        ...
        auth2AuthorizationRequestBasedOnCookieRepository.removeAuthorizationReqeustCookies(request,response);
    }
